...
import { BookOpen, HelpCircle, Brain, MessageCircle, ShieldCheck, Truck } from "lucide-react";

const features = [
    {
        title: "Concept Learning",
        description:
            "Structured learning paths with short sessions, visual explanations, and understanding checks.",
        icon: BookOpen,
    },
    {
        title: "Homework Help",
        description:
            "Ask any question and get step-by-step explanations tailored to your understanding.",
        icon: HelpCircle,
    },
    {
        title: "Quiz & Practice",
        description:
            "Practice with quizzes and track mastery across topics easily.",
        icon: Brain,
    },
    {
        title: "AI Chat & Summary",
        description:
            "Get summaries and chat anytime about previously learned topics.",
        icon: MessageCircle,
    },
    {
        title: "Smart Learning System",
        description:
            "AI adapts to your pace and learning style for better retention.",
        icon: ShieldCheck,
    },
    {
...
export default function FourWaysToLearn() {
    return (
        <section className="w-full py-24 px-6 lg:px-20 bg-gray-50">
            <div className="max-w-6xl mx-auto">
                ...
                {/* Grid */}
                <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 border border-gray-200 rounded-2xl overflow-hidden bg-white">
                ...
                `}
                            >
                                {/* Icon */}
                                <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-green-100 mb-5">
